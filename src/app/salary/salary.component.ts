...
export class SalaryComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.dp.valueChanges.subscribe(
            (value) => {
                this.iv.patchValue(((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - value) * this.ivP.value * 0.01).toFixed(2))
                this.salaryN.patchValue((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.iv.value).toFixed(2))
            })
        this.casaP.valueChanges.subscribe((value) => {
            this.casa.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.iv.patchValue(((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.dp.value) * this.ivP.value * 0.01).toFixed(2))
            this.salaryN.patchValue((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.iv.value).toFixed(2))
        })
        this.cassaP.valueChanges.subscribe((value) => {
            this.cassa.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.iv.patchValue(((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.dp.value) * this.ivP.value * 0.01).toFixed(2))
            this.salaryN.patchValue((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.iv.value).toFixed(2))
        })
        this.cfsaP.valueChanges.subscribe((value) => {
            this.cfsa.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.iv.patchValue(((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.dp.value) * this.ivP.value * 0.01).toFixed(2))
            this.salaryN.patchValue((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.iv.value).toFixed(2))
        })
        ...
        this.ivP.valueChanges.subscribe((value) => {
            this.iv.patchValue(((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.dp.value) * value * 0.01).toFixed(2))
            this.salaryN.patchValue((this.salaryB.value - this.casa.value - this.cassa.value - this.cfsa.value - this.iv.value).toFixed(2))
        })
        this.casP.valueChanges.subscribe((value) => {
            this.cas.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
        ...
        this.cassP.valueChanges.subscribe((value) => {
            this.cass.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.salaryC.patchValue((this.salaryB.value + this.cas.value + this.cass.value + this.cfs.value + this.cci.value + this.fgpcs.value + this.ambp.value).toFixed(2))
        })
        this.cfsP.valueChanges.subscribe((value) => {
            this.cfs.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.salaryC.patchValue((this.salaryB.value + this.cas.value + this.cass.value + this.cfs.value + this.cci.value + this.fgpcs.value + this.ambp.value).toFixed(2))
        })
        this.cciP.valueChanges.subscribe((value) => {
            this.cci.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.salaryC.patchValue((this.salaryB.value + this.cas.value + this.cass.value + this.cfs.value + this.cci.value + this.fgpcs.value + this.ambp.value).toFixed(2))
        })
        this.fgpcsP.valueChanges.subscribe((value) => {
            this.fgpcs.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.salaryC.patchValue((this.salaryB.value + this.cas.value + this.cass.value + this.cfs.value + this.cci.value + this.fgpcs.value + this.ambp.value).toFixed(2))
        })
        this.ambpP.valueChanges.subscribe((value) => {
            this.ambp.patchValue((this.salaryB.value * value * 0.01).toFixed(2))
            this.salaryC.patchValue((this.salaryB.value + this.cas.value + this.cass.value + this.cfs.value + this.cci.value + this.fgpcs.value + this.ambp.value).toFixed(2))
        })
